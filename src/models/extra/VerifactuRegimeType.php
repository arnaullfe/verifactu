...
/**
 * Claves de Régimen Especial o Trascendencia Adicional (VerifactuRegimeType)
 */
enum VerifactuRegimeType: string {
    ...
    const C11 = '11';
    /** Factura con IVA pendiente de devengo en certificaciones de obra cuyo destinatario sea Administración Pública. */
    const C14 = '14';
    ...
    const C18 = '18';
    /** Operaciones de actividades incluidas en el REAGYP */
    const C19 = '19';
